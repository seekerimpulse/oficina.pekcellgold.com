...
<html>
	...
	<body>
		...
		<img src="http://dev.sionlinesoft.com/template/img/login.jpg" alt="login.jpg" width="500" height="200">
		<main>
			<form>
		<h1 style="font-size: 100px/60px Arial, Helvetica, sans-serif; margin: 0; padding: 0 0 18px; color: white;"><div id="container" styale="width:1000px">
			...
			<p>para terminar y verificar su e-mail vaya al siguiente sitio:</p><br>
				<a href="http://dev.sionlinesoft.com/auth/login" target="_blank">Presione para terminar su regirstro.</a>
