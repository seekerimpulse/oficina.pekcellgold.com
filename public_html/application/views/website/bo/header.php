	...
	<body class="desktop-detected pace-done hidden-menu">
		...
		<!-- #HEADER -->
		<header id="header" class="text-center" style="height: 70px">
			<div id="logo-group">

				<!-- PLACE YOUR LOGO HERE -->
				<span id="logo"> <a href="/bo/dashboard"><img style="width: 40px; height: auto;" src="/wl_.png" alt="Networksoft"> </a></span>
			...
			<div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 pull-right">
				...
				<ul class="header-dropdown-list hidden-xs">
					<li>
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="/template/img/blank.gif" class="flag flag-es" alt="Spanish"><span> Español </span> <i class="fa fa-angle-down"></i> </a>
						<ul class="dropdown-menu pull-right">
							<li>
