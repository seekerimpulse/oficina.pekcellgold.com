												...
												<fieldset>
													...
													<section class="col col-2" style="width: 50%;">
														<label class="input">Fecha de inicio
															<input required type="text" value='<?php echo $data_merc[0]->fecha_inicio?>' name="fecha_inicio" id="startdate">
														</label>
													</section>
													
													<section class="col col-2" style="width: 50%;">
														<label class="input">Fecha de termino
															<input type="text" value='<?php echo $data_merc[0]->fecha_fin?>' name="fecha_fin" id="finishdate"> 
														</label>
													</section>
