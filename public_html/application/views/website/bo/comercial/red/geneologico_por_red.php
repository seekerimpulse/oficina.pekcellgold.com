                         ...
                         <div class="col-xs-8 col-sm-7 col-md-7 col-lg-8">
                              <h1 class="page-title txt-color-blueDark">
                                   <a class="backHome" href="/bo"><i class="fa fa-home"></i> Menu</a>
									...
									<span>>
										<a href="/bo/comercial/tipos_de_red_genealogico?id_afiliado=<?php echo $id;?>">Selección de Red</a> > Genealogico <?php echo $nombre_red[0]->nombre;?>
									</span>
                              </h1>
                         </div>
                    </div>
                                   ...
                                   <!-- Widget ID (each widget will need unique ID)-->
                                    <div class="jarviswidget jarviswidget-color-purity" id="wid-id-0" data-widget-editbutton="false" data-widget-colorbutton="false">
                                        ...
                                        <header>
                                             ...
                                             <h2>Genialogico <?php echo $nombre_red;?></h2>
